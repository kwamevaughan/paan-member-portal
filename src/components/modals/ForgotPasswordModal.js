      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end space-x-2">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 text-gray-600 hover:text-paan-red"
          >
            Cancel
          </button>
          <button
            ...
            className={`px-4 py-2 bg-paan-red text-white font-bold rounded-full transform transition-transform duration-300 ease-in-out hover:scale-105 ${
